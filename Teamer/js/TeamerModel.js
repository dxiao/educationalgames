...
(function() {
  var Function, FunctionFamily, GameInfo, GameStatus, ImplRating, ImplReview, ImplReviewSet, Implementation, Module, Player, PlayerView, PlayerView2, PlayerView3, ProblemSuite, implTemplate, _,
    __slice = [].slice,
  ...
  Module.Implementation = Implementation = (function() {
    function Implementation(_function, player, code) {
      ...
      this.code = code;
      if (this.code == null) {
        this.code = _.format(implTemplate, this.getClassName());
      }
    }

    Implementation.prototype.getClassName = function() {
      return "C" + this["function"].name + this.player.id;
    };
